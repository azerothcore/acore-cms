...
function acore_dark_mode_enqueue() {
    wp_enqueue_style('acore-dark-mode', ACORE_URL_PLG . 'web/assets/css/dark-mode.css', [], '1.2');
...
function acore_dark_mode_late_styles() {
    ...
    <style id="acore-dark-mode-late">
        /* character list rows */
        .acore-dark-mode .acore-char-row { background: #1c2128 !important; border-color: #30363d !important; }
        .acore-dark-mode .acore-char-name { color: #c9d1d9 !important; }
        .acore-dark-mode .acore-char-meta { color: #8b949e !important; }
        .acore-dark-mode #acore-characters-mail .acore-char-row.active { background: #1f3a5c !important; border-color: #58a6ff !important; }
