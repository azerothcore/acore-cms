...
function acore_dark_mode_enqueue() {
    wp_enqueue_style('acore-css', ACORE_URL_PLG . 'web/assets/css/main.css', [], '2.9');
    wp_enqueue_style('acore-dark-mode', ACORE_URL_PLG . 'web/assets/css/dark-mode.css', ['acore-css'], '3.5');
