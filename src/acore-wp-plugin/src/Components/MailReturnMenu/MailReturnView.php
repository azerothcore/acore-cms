...
class MailReturnView
{
    ...
    public function getMailReturnRender($chars)
    {
        ...
        wp_enqueue_script('power-js', 'https://wowgaming.altervista.org/aowow/static/widgets/power.js', array(), null, false);
        wp_enqueue_script('acore-mail-return-js', ACORE_URL_PLG . 'web/assets/mail-return/mail-return.js', array('jquery'), '2.4', true);
